...
} from "@/components/employer-add-jobs/ApplicationProcessCard"
import {
  SalaryIndicationCard,
  type SalaryIndicationData,
} from "@/components/employer-add-jobs/SalaryIndicationCard"
import {
  ReleaseDatesCard,
  type ReleaseDatesData,
} from "@/components/employer-add-jobs/ReleaseDatesCard"
import {
  KeywordsCard,
  type KeywordsData,
} from "@/components/employer-add-jobs/KeywordsCard"
import {
  CompanyInformationCard,
  type CompanyInformationData,
} from "@/components/employer-add-jobs/CompanyInformationCard"
import {
  WorkplaceCard,
  type WorkplaceData,
} from "@/components/employer-add-jobs/WorkplaceCard"
import {
  JobAdvertisementInfoCard,
  type JobAdvertisementInfoData,
} from "@/components/employer-add-jobs/JobAdvertisementInfoCard"
